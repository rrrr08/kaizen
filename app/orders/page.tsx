      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex gap-3 mb-8">
          <button
            ...
            className={`flex items-center gap-2 px-6 py-3 font-black text-sm uppercase tracking-widest rounded-xl border-2 border-black transition-all neo-shadow ${
              activeTab === 'shop'
                ? 'bg-black text-white'
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                          ...
                          <div>
                            <p className="text-black/40 text-[10px] font-black uppercase tracking-[0.2em] mb-1">Status</p>
                            <span className={`inline-flex items-center px-2 py-1 border border-black rounded-md text-[10px] font-black uppercase ${
                              registration.status === 'registered' ? 'bg-[#00B894] text-white' :
