    ...
    <div className="min-h-screen pt-32 pb-16 bg-[#FFFDF5] text-[#2D3436]">
      <div className="max-w-3xl mx-auto px-6 md:px-12">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-black/70 font-bold max-w-lg mx-auto italic">
        ...
        <div className="bg-white border-2 border-black rounded-[25px] p-8 neo-shadow mb-8 relative overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 relative z-10">
            <div>
              ...
              <p className="font-mono text-xs font-bold bg-[#F0F0F0] px-3 py-1 rounded border border-black/10 inline-block">{order.id}</p>
            </div>
            <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white border-2 border-black rounded-[25px] p-8 neo-shadow">
            <h2 className="font-header text-2xl mb-6 font-black uppercase flex items-center gap-2">
              <ShoppingBag size={24} /> THE LOOT
            </h2>
            <div className="space-y-4">
              {order.items.map((item: any, idx: number) => (
                <div key={idx} className="flex justify-between items-start pb-4 border-b-2 border-black/5 last:border-0 last:pb-0 font-bold text-sm">
                  <div>
                    <p className="text-black uppercase">{item.product.name}</p>
          ...
          <div className="bg-[#FFFDF5] border-2 border-black rounded-[25px] p-8 neo-shadow">
            <h2 className="font-header text-2xl mb-6 font-black uppercase">SHIPPING TO</h2>
